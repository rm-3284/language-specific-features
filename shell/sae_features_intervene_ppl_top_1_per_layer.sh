...
run_intervention() {
       ...
       python "$DIR/../scripts/ppl.py" meta-llama/Llama-3.2-1B openlanguagedata/flores_plus \
              ...
              --lape-result-path sae_features_specific/meta-llama/Llama-3.2-1B/EleutherAI/sae-Llama-3.2-1B-131k/lape_top_1_per_layer.pt \
              --out-path sae_intervention/top_1_per_layer/avg/mult_${multiplier_value}/ppl_${lang}.pt \
              --lape-value-type final_indice_global_avg_active
}
